(()=> {
  function a(a, e, i, r) {
    Object.defineProperty(a, e,  {
      get:i, set:r, enumerable:!0, configurable:!0
    })
  }
  ...
  null==t&&((t=function(a) {
    ...
    const t=a=> {
      ...
      return r>=0?t="back-forward-cache":i&&(document.prerendering||s()>0?t="prerender":document.wasDiscarded?t="restore":i.type&&(t=i.type.replace(/_/g, "-"))),  {
        name:a, value:e, rating:"good", delta:0, entries:[], id:`v5-${
          Date.now()
        }
        -${
    ...
    class m {
      ...
      h(a) {
        ...
        const e=this.o[0], i=this.o.at(-1);
    ...
    let g=-1;
    const f=()=>"hidden"!==document.visibilityState||document.prerendering?1/0:0, h=a=> {
      ...
      if(g<0) {
        const a=s(), e=document.prerendering?void 0:globalThis.performance.getEntriesByType("visibility-state").filter((e=>"hidden"===e.name&&e.startTime>a))[0]?.startTime;
        g=e??f(), S(), t((()=> {
          setTimeout((()=> {
            g=f(), S()
          }))
      ...
      h(a) {
        ...
        if(i||this.u.length<10||a.duration>e.T) {
          if(i?a.duration>i.T?(i.entries=[a], i.T=a.duration):a.duration===i.T&&a.startTime===i.entries[0].startTime&&i.entries.push(a):(i= {
            id:a.interactionId, entries:[a], T:a.duration
    ...
    const D=[2500, 4e3], F=(a, e= {
      ...
      let i=A("TTFB"), r=n(a, i, O, e.reportAllChanges);
      x((()=> {
        const o=c();
    ...
    const r= {
      cookie:"cookie", localStorage:"localStorage", sessionStorage:"sessionStorage"
    };
    let n, o, c, s, A, u=r.cookie, l= {
    }, m=!0;
    ...
    function g() {
      if([r.localStorage, r.sessionStorage].includes(u)) {
        const a=u===r.localStorage?localStorage:sessionStorage, i=a.getItem(e);
        if(!i)return null;
        let t=null;
        try {
          t=JSON.parse(i)
    ...
    function f() {
      ...
      if([r.localStorage, r.sessionStorage].includes(u)) {
        const i= {
          value:a, expiry:(new Date).getTime()+18e5
        }, t=JSON.stringify(i), n=u===r.localStorage?localStorage:sessionStorage;
        return u===n.setItem(e, t)
      }
      return function(a) {
        let e=`session-id=${
          a
        }; Max-Age=1800; path=/; secure`;
        A&&(e+=`; domain=${
          A
        }
        `), document.cookie=e
    ...
    async function v(a, e) {
      ...
      /api/tracking`:s?(s=s.replaceAll(/\/+$/gm, ""), t=`${
        s
      }
      /v0/events?name=${
        i
      ...
      `):t=`https://api.tinybird.co/v0/events?name=${
        i
      }
      &token=${
        c
      ...
      `, m) {
        if(A=S(e), A=Object.assign( {
        }, JSON.parse(A), l), A=JSON.stringify(A), !h(A))return
      }
      else {
        A=Object.assign( {
        }, e, l);
      ...
      const u=g()||p(), d=new XMLHttpRequest;
      d.open("POST", t, !0), d.setRequestHeader("Content-Type", "application/json"), d.send(JSON.stringify( {
        timestamp:(new Date).toISOString(), action:a, version:"1", session_id:u, payload:A
      }))
    }
    function C() {
      let e, i;
    ...
    function y() {
      ...
      setTimeout((()=> {
        v("page_hit",  {
          "user-agent":window.navigator.userAgent, locale:e, location:a, referrer:document.referrer, pathname:window.location.pathname, href:window.location.href
        })
      }), 300)
    }
    if(d) {
      function T(a) {
        try {
          ...
          =C();
          v("web_vital",  {
            name:a.name, value:a.value, delta:a.delta, rating:a.rating, id:a.id, navigationType:a.navigationType, pathname:window.location.pathname, href:window.location.href, "user-agent":window.navigator.userAgent, locale:i, location:e, referrer:document.referrer
          })
        }
        catch(a) {
